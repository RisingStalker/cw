...
class StoreItemRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        ...
        \Log::info('StoreItemRequest - Raw variations input', [
        ...
        if (is_array($variationsInput)) {
            ...
            foreach ($variationsInput as $index => $variation) {
                ...
                \Log::info("StoreItemRequest - Price tables for variation {$index}", [
            ...
            \Log::info('StoreItemRequest - Processed variations', [
