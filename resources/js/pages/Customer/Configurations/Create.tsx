        ...
        <CustomerLayout>
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight">Create Configuration</h1>
                        <p className="text-muted-foreground mt-2">Start configuring your project: {project.name}</p>
                    </div>
                </div>
                ...
                <form onSubmit={submit} className="max-w-2xl space-y-6">
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            required
                            autoFocus
                            placeholder="e.g., Main Configuration, Alternative Option"
                        />
                        <InputError message={errors.name} />
                        <p className="text-sm text-muted-foreground">
                            Give your configuration a descriptive name to identify it later
                        </p>
                    </div>
                    ...
                    <div className="flex gap-4">
                        <Button type="submit" disabled={processing}>
                            {processing && <Spinner />}
                            Create and Start Configuration
                        </Button>
                        <Link href={configurationsIndex({ project: project.id }).url}>
